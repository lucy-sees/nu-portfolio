  ...
  try {
    ...
    const chat = model.startChat({
      history: [
        {
          role: "user",
          parts: `You are an AI assistant for Lucy W. Mwangi. Use the following information to help answer questions:
